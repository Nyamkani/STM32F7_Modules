...
int main(void)
{
  ...
  /*Constructor*/
  CommonSensor AORG_L(0x00, ActiveH, Filter_5, GPIOG, GPIO_PIN_9);

  CommonSensor AORG_R(0x01, ActiveH, Filter_5, GPIOG, GPIO_PIN_10);
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	 ...
	 //bool your_IO_data = AORG_L.GetSensorData();

	 //bool your_IO_data = AORG_R.GetSensorData();
