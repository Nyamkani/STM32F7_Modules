...
int main(void)
{
  ...
  /*Main Constructor*/
  PGV100 pgv100_(0x00, RS485, &huart5, GPIOB, GPIO_PIN_0, milimeter_1, 0.0, 0.0, 0.0);

  PCV80 pcv80_(0x00, RS485, &huart6, GPIOB, GPIO_PIN_1, milimeter_1, 0.0, 0.0);

  pgv100_.Initialization();

  pcv80_.Initialization();
  ...
  while (1)
  {
    /* USER CODE END WHILE */
	  ...
	  HAL_Delay(50);
	  /*
	   * 	double your_pcv80_xpos_val = pcv80_.GetXOffset();
	   * 	double your_pcv80_ypos_val = pcv80_.GetYOffset();
	   *
	   *	double your_pgv100_xpos_val = pgv100_.GetXOffset();
	   * 	double your_pgv100_ypos_val = pgv100_.GetYOffset();
	   * 	double your_pgv100_ypos_val = pgv100_.GetAngle();
	   * 	int your_TagNo_ypos_val = pgv100_.GetTagNo();
	   *
	   * */
    /* USER CODE BEGIN 3 */
  }
