...
/*
	switch(id)
	{
		...
		case abort_id: this->comm_stat_reg_ = CAN_ABORT_ID_ERROR;  break;	//aborted -> CAN comm. error
...
/*
	if(this->comm_stat_reg_ == CAN_ABORT_ID_ERROR)
	{
		this->comm_stat_reg_ = COMM_OK;
...
bool BG95::CheckErrorStatus()
{
	...
	//if(IsReceiveQueueEmpty()) return false;
