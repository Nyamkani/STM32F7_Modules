...
CPP_SRCS += \
../Core/Module/api_timer/apitimer.cpp 

OBJS += \
./Core/Module/api_timer/apitimer.o 

CPP_DEPS += \
./Core/Module/api_timer/apitimer.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Module/api_timer/%.o Core/Module/api_timer/%.su: ../Core/Module/api_timer/%.cpp Core/Module/api_timer/subdir.mk
...
clean: clean-Core-2f-Module-2f-api_timer

clean-Core-2f-Module-2f-api_timer:
	-$(RM) ./Core/Module/api_timer/apitimer.d ./Core/Module/api_timer/apitimer.o ./Core/Module/api_timer/apitimer.su

.PHONY: clean-Core-2f-Module-2f-api_timer
