...
C_SRCS += \
../Core/Module/bootloader/etx_ota_update.c 

C_DEPS += \
./Core/Module/bootloader/etx_ota_update.d 

OBJS += \
./Core/Module/bootloader/etx_ota_update.o 


# Each subdirectory must supply rules for building sources it contributes
Core/Module/bootloader/%.o Core/Module/bootloader/%.su: ../Core/Module/bootloader/%.c Core/Module/bootloader/subdir.mk
...
clean: clean-Core-2f-Module-2f-bootloader

clean-Core-2f-Module-2f-bootloader:
	-$(RM) ./Core/Module/bootloader/etx_ota_update.d ./Core/Module/bootloader/etx_ota_update.o ./Core/Module/bootloader/etx_ota_update.su

.PHONY: clean-Core-2f-Module-2f-bootloader
